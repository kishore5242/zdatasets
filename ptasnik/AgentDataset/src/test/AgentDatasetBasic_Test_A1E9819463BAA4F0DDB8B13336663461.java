...
public class AgentDatasetBasic_Test_A1E9819463BAA4F0DDB8B13336663461 extends LTTestScript  {
	...
	public AgentDatasetBasic_Test_A1E9819463BAA4F0DDB8B13336663461(IContainer container, String invocationId) {
		super(container, "AgentDatasetBasic", invocationId, "A1E9819463BAA4F0DDB8B13336663461");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(new CustomCode_1(this, dcVars[1]));
		     ...
		     log("Test Execution: AgentDatasetBasic_Test_A1E9819463BAA4F0DDB8B13336663461 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	private DatapoolAction datapool_1(IContainer parent) {
		DatapoolAction dpAction = new DatapoolAction(parent, "AgentDS.csv", "A1E981948EB4D770DDB8B13336663461", false);
		Datapool dp = new Datapool(
				 "/L0FnZW50RGF0YXNldC9BZ2VudERTLmNzdg==.csv",
				 "C:\\temp\\agent\\AgentDataset\\AgentDS.csv",
				 0,
				 true,
				 false,
				 Datapool.SEQUENTIAL,
	...
	public class CustomCode_1 extends CustomCodeAction {
		...
		public CustomCode_1(IContainer parent, IDataCorrelationVar outVar) {
			super(parent, "customcode.Class", "A1E981948A1B5220DDB8B13336663461");
			this.outVar = outVar;
		}
